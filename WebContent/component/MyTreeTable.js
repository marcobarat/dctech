...
// Provides control sap.ui.table.MyTreeTable.
sap.ui.define(['jquery.sap.global', 'sap/ui/table/Table', 'sap/ui/model/odata/ODataTreeBindingAdapter', 'sap/ui/model/ClientTreeBindingAdapter', 'sap/ui/model/TreeBindingCompatibilityAdapter', 'sap/ui/table/library', 'sap/ui/core/Element'],
        function (jQuery, Table, ODataTreeBindingAdapter, ClientTreeBindingAdapter, TreeBindingCompatibilityAdapter, library, Element) {
            "use strict";

            /**
             * Constructor for a new MyTreeTable.
             *
             * @param {string} [sId] id for the new control, generated automatically if no id is given
             * @param {object} [mSettings] initial settings for the new control
             *
             * @class
             * The MyTreeTable control provides a comprehensive set of features to display hierarchical data.
             * @extends sap.ui.table.Table
             * @version 1.38.5
             *
             * @constructor
             * @public
             * @alias sap.ui.table.MyTreeTable
             * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
             */
            var MyTreeTable = Table.extend("myapp.component.MyTreeTable", /** @lends sap.ui.table.MyTreeTable.prototype */ {metadata: {
                    ...
                    properties: {
                         ...
                         */
                        color: {type: "string", defaultValue: "nero"},
                        numberOfRows: {type: "int", defaultValue: 0},
                         ...
                         * This property is only supported when the MyTreeTable uses an underlying odata services with hierarchy annotations.
                         * This property is only supported with sap.ui.model.odata.v2.ODataModel
            ...
            /**
             * Initialization of the MyTreeTable control
             * @private
             */
            MyTreeTable.prototype.init = function () {
                Table.prototype.init.apply(this, arguments);
                this._iLastFixedColIndex = 0;
                this.expandToLevel(10);
            };

            MyTreeTable.prototype.bindRows = function (oBindingInfo, vTemplate, aSorters, aFilters) {
                var sPath,
                        oTemplate,
                        aSorters,
                        aFilters;
             ...
             */
            MyTreeTable.prototype.setSelectionMode = function (sSelectionMode) {
             ...
             * @private
             */
            MyTreeTable.prototype.refreshRows = function (sReason) {
             ...
             *
             * <b>This property is not supportd for the MyTreeTable and will be ignored!</b>
             *
             * Default value is <code>0</code>
             *
             * @param {int} iFixedRowCount  new value for property <code>fixedRowCount</code>
             * @return {sap.ui.table.MyTreeTable} <code>this</code> to allow method chaining
             * @public
             */
            MyTreeTable.prototype.setFixedRowCount = function (iRowCount) {
                // this property makes no sense for the MyTreeTable
                jQuery.sap.log.warning("MyTreeTable: the property \"fixedRowCount\" is not supported and will be ignored!");
                return this;
            };


            MyTreeTable.prototype.isTreeBinding = function (sName) {
                sName = sName || "rows";
                if (sName === "rows") {
                    return true;
                }
            ...
            MyTreeTable.prototype.getBinding = function (sName) {
                sName = sName || "rows";
                ...
                if (oBinding && sName === "rows" && !oBinding.getLength) {
                    ...
                    if (ODataTreeBinding && oBinding instanceof ODataTreeBinding) {
                        ...
                        jQuery.sap.log.error("Binding not supported by sap.ui.table.MyTreeTable");
                    }
                }
                return oBinding;
            };

            MyTreeTable.prototype._updateTableContent = function () {
                var oBinding = this.getBinding("rows"),
            ...
            MyTreeTable.prototype._updateTableCell = function () {
                return true;
            };

            MyTreeTable.prototype._updateExpandState = function (oRow, $Row) {
            ...
            MyTreeTable.prototype._getLevelIndentCSS = function (oRow) {
                if (!this.getUseGroupMode()) {
                    var sPropertyName = "";
            ...
            MyTreeTable.prototype._getContexts = function (iStartIndex, iLength, iThreshold) {
                var oBinding = this.getBinding("rows");
                if (oBinding) {
            ...
            MyTreeTable.prototype._onGroupHeaderChanged = function (iRowIndex, bExpanded) {
             ...
             * @return {sap.ui.table.MyTreeTable} a reference on the MyTreeTable control, can be used for chaining
             * @public
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.expand = function (iRowIndex) {
                var oBinding = this.getBinding("rows");
            ...
            MyTreeTable.prototype.expandAll = function () {
                var oBinding = this.getBinding("rows"),
                        iFirstRow = this.getFirstVisibleRow(),
                        aRows = this.getRows(),
                        iCount = aRows.length,
                ...
                if (oBinding) {
                    ...
                    for (var iRow = 0; iRow < iCount; iRow++) {
                        ...
                        this._updateExpandState(aRows[iRow], $row);
                        try {
                            var temp = this.getContextByIndex(iRow).getObject();
                            if (temp.expand == 0) {
                                oContext.collapse(iRow);
                            }
                        } catch (err) {
                        }
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.collapse = function (iRowIndex) {
                var oBinding = this.getBinding("rows");
                if (oBinding && iRowIndex >= 0) {
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.collapseAll = function () {
                var oBinding = this.getBinding("rows");
                if (oBinding) {
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.expandToLevel = function (iLevel) {
                var oBinding = this.getBinding("rows");

                jQuery.sap.assert(oBinding && oBinding.expandToLevel, "MyTreeTable.expandToLevel is not supported with your current Binding. Please check if you are running on an ODataModel V2.");
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.isExpanded = function (iRowIndex) {
                var oBinding = this.getBinding("rows");
                if (oBinding) {
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.isIndexSelected = function (iRowIndex) {
                var oBinding = this.getBinding("rows");
             ...
             * In a MyTreeTable you can only select indices, which correspond to the currently visualized tree.
             * Invisible tree nodes (e.g. collapsed child nodes) can not be selected via Index, because they do not
             * correspond to a MyTreeTable row.
             *
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.setSelectedIndex = function (iRowIndex) {
                if (iRowIndex === -1) {
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.getSelectedIndices = function () {
                //when using the treebindingadapter, check if the node is selected
                var oBinding = this.getBinding("rows");

                if (oBinding && oBinding.findNode && oBinding.getSelectedIndices) {
                    /*jQuery.sap.log.warning("When using a MyTreeTable on a V2 ODataModel, you can also use 'getSelectedContexts' on the underlying TreeBinding," +
            ...
            /**
             * Sets the selection of the MyTreeTable to the given range (including boundaries).
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.setSelectionInterval = function (iFromIndex, iToIndex) {
                //when using the treebindingadapter, check if the node is selected
                var oBinding = this.getBinding("rows");
             ...
             * Please be aware, that the absolute row index only applies to the the tree which is visualized by the MyTreeTable.
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.addSelectionInterval = function (iFromIndex, iToIndex) {
                var oBinding = this.getBinding("rows");
                //TBA check
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.removeSelectionInterval = function (iFromIndex, iToIndex) {
                var oBinding = this.getBinding("rows");
                //TBA check
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.selectAll = function () {
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.getSelectedIndex = function () {
                //when using the treebindingadapter, check if the node is selected
                var oBinding = this.getBinding("rows");
             ...
             * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
             */
            MyTreeTable.prototype.clearSelection = function () {
                var oBinding = this.getBinding("rows");
            ...
            MyTreeTable.prototype.getContextByIndex = function (iRowIndex) {
                var oBinding = this.getBinding("rows");
                if (oBinding) {
             ...
             * @returns {MyTreeTable}
             */
            MyTreeTable.prototype.setRootLevel = function (iRootLevel) {
                this.setFirstVisibleRow(0);
             ...
             */
            MyTreeTable.prototype.setCollapseRecursive = function (bCollapseRecursive) {
                var oBinding = this.getBinding("rows");
                if (oBinding) {
             ...
             * @private
             */
            MyTreeTable.prototype._getSelectedIndicesCount = function () {
